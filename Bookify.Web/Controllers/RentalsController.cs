...
namespace Bookify.Web.Controllers
{
    ...
    public class RentalsController : Controller
    {
        ...
        public IActionResult Create(RentalFormViewModel model)
        {
            ...
            var currentSubscriberRentals = _context.Rental
            ...
            foreach (var copy in selectedCopies)
            {
                ...
                if (copy.Rentals.Any(c => !c.ReturnedDate.HasValue))
        ...
        public IActionResult GetCopyDetails(SearchFormViewModel model)
        {
            ...
            var copyIsRental = _context.RentalCopies.Any(c => c.BookCopyId == copy.Id && !c.ReturnedDate.HasValue);
            if (copyIsRental)
            {
        ...
        private (string errorMessage, int? maxAllowedCopies) ValidateSubscriber(Subscriber subscriber)
        {
            ...
            var currentRentals = subscriber.Rentals.SelectMany(r => r.RentalCopies).Count(c => !c.ReturnedDate.HasValue);
